...
| `BUILD-SPEC-PROCESS.md` | My Process section (original hover-driven horizontal timeline) + All Work → `/work.html` | ⚠️ Partly superseded — the hover timeline is now a pinned, vertical, scroll-scrubbed ScrollTrigger sequence (desktop) that stacks unpinned on mobile; the All Work → `/work.html` link still stands |
